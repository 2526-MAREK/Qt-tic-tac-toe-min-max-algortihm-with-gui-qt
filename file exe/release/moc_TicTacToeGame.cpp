...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TicTacToeGame_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TicTacToeGame_t qt_meta_stringdata_TicTacToeGame = {
    {
QT_MOC_LITERAL(0, 13), // "TicTacToeGame"
QT_MOC_LITERAL(14, 7), // "newGame"
QT_MOC_LITERAL(22, 0) // ""

    },
    "TicTacToeGame\0newGame\0"
};
...
void TicTacToeGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TicTacToeGame::newGame)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TicTacToeGame::staticMetaObject = { {
    ...
    qt_meta_stringdata_TicTacToeGame.offsetsAndSize,
    qt_meta_data_TicTacToeGame,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TicTacToeGame_t
, QtPrivate::TypeAndForceComplete<TicTacToeGame, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
